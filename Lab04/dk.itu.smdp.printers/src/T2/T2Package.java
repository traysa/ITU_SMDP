...
public interface T2Package extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://www.itu.dk/people/wasowski/dk.itu.smdp.printers.T2";
	 ...
	 * @generated
	 */
	T2Package eINSTANCE = T2.impl.T2PackageImpl.init();

	/**
	 * The meta object id for the '{@link T2.impl.PrinterPoolImpl <em>Printer Pool</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see T2.impl.PrinterPoolImpl
	 * @see T2.impl.T2PackageImpl#getPrinterPool()
	 * @generated
	 */
	int PRINTER_POOL = 0;
	...
	/**
	 * The meta object id for the '{@link T2.impl.CopierImpl <em>Copier</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see T2.impl.CopierImpl
	 * @see T2.impl.T2PackageImpl#getCopier()
	 * @generated
	 */
	int COPIER = 1;
	...
	/**
	 * The meta object id for the '{@link T2.impl.ScannerImpl <em>Scanner</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see T2.impl.ScannerImpl
	 * @see T2.impl.T2PackageImpl#getScanner()
	 * @generated
	 */
	int SCANNER = 2;
	...
	/**
	 * The meta object id for the '{@link T2.impl.FaxImpl <em>Fax</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see T2.impl.FaxImpl
	 * @see T2.impl.T2PackageImpl#getFax()
	 * @generated
	 */
	int FAX = 3;
	...
	/**
	 * The meta object id for the '{@link T2.impl.PrinterImpl <em>Printer</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see T2.impl.PrinterImpl
	 * @see T2.impl.T2PackageImpl#getPrinter()
	 * @generated
	 */
	int PRINTER = 4;
	...
	/**
	 * Returns the meta object for class '{@link T2.PrinterPool <em>Printer Pool</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference '{@link T2.PrinterPool#getPrinter <em>Printer</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference '{@link T2.PrinterPool#getFax <em>Fax</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Fax</em>'.
	 * @see T2.PrinterPool#getFax()
	 * @see #getPrinterPool()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the containment reference '{@link T2.PrinterPool#getCopier <em>Copier</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference '{@link T2.PrinterPool#getScanner <em>Scanner</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link T2.Copier <em>Copier</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the container reference '{@link T2.Copier#getPool <em>Pool</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the container reference '<em>Pool</em>'.
	 * @see T2.Copier#getPool()
	 * @see #getCopier()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link T2.Scanner <em>Scanner</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the container reference '{@link T2.Scanner#getPool <em>Pool</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the container reference '<em>Pool</em>'.
	 * @see T2.Scanner#getPool()
	 * @see #getScanner()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link T2.Fax <em>Fax</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the container reference '{@link T2.Fax#getPool <em>Pool</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the container reference '<em>Pool</em>'.
	 * @see T2.Fax#getPool()
	...
	/**
	 * Returns the meta object for class '{@link T2.Printer <em>Printer</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the container reference '{@link T2.Printer#getPool <em>Pool</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the container reference '<em>Pool</em>'.
	 * @see T2.Printer#getPool()
	 * @see #getPrinter()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link T2.impl.PrinterPoolImpl <em>Printer Pool</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see T2.impl.PrinterPoolImpl
		 * @see T2.impl.T2PackageImpl#getPrinterPool()
		...
		/**
		 * The meta object literal for the '{@link T2.impl.CopierImpl <em>Copier</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see T2.impl.CopierImpl
		 * @see T2.impl.T2PackageImpl#getCopier()
		...
		/**
		 * The meta object literal for the '{@link T2.impl.ScannerImpl <em>Scanner</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see T2.impl.ScannerImpl
		 * @see T2.impl.T2PackageImpl#getScanner()
		...
		/**
		 * The meta object literal for the '{@link T2.impl.FaxImpl <em>Fax</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see T2.impl.FaxImpl
		 * @see T2.impl.T2PackageImpl#getFax()
		...
		/**
		 * The meta object literal for the '{@link T2.impl.PrinterImpl <em>Printer</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see T2.impl.PrinterImpl
		 * @see T2.impl.T2PackageImpl#getPrinter()
