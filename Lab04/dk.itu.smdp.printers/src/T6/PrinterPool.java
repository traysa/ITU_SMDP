 ...
 * <ul>
 *   <li>{@link T6.PrinterPool#getPrinter <em>Printer</em>}</li>
 *   <li>{@link T6.PrinterPool#getScanner <em>Scanner</em>}</li>
 * </ul>
 * </p>
 *
 * @see T6.T6Package#getPrinterPool()
 * @model
 * @generated
 */
public interface PrinterPool extends EObject {
	 ...
	 * The list contents are of type {@link T6.Printer}.
	 * It is bidirectional and its opposite is '{@link T6.Printer#getPool <em>Pool</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see T6.T6Package#getPrinterPool_Printer()
	 ...
	 * The list contents are of type {@link T6.Scanner}.
	 * It is bidirectional and its opposite is '{@link T6.Scanner#getPool <em>Pool</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see T6.T6Package#getPrinterPool_Scanner()
