...
public interface T6Package extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://www.itu.dk/people/wasowski/dk.itu.smdp.printers.T6";
	 ...
	 * @generated
	 */
	T6Package eINSTANCE = T6.impl.T6PackageImpl.init();

	/**
	 * The meta object id for the '{@link T6.impl.PrinterPoolImpl <em>Printer Pool</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see T6.impl.PrinterPoolImpl
	 * @see T6.impl.T6PackageImpl#getPrinterPool()
	 * @generated
	 */
	int PRINTER_POOL = 0;
	...
	/**
	 * The meta object id for the '{@link T6.impl.PrinterImpl <em>Printer</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see T6.impl.PrinterImpl
	 * @see T6.impl.T6PackageImpl#getPrinter()
	 * @generated
	 */
	int PRINTER = 1;
	...
	/**
	 * The meta object id for the '{@link T6.impl.ScannerImpl <em>Scanner</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see T6.impl.ScannerImpl
	 * @see T6.impl.T6PackageImpl#getScanner()
	 * @generated
	 */
	int SCANNER = 2;
	...
	/**
	 * Returns the meta object for class '{@link T6.PrinterPool <em>Printer Pool</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference list '{@link T6.PrinterPool#getPrinter <em>Printer</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Printer</em>'.
	 * @see T6.PrinterPool#getPrinter()
	 * @see #getPrinterPool()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the containment reference list '{@link T6.PrinterPool#getScanner <em>Scanner</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Scanner</em>'.
	 * @see T6.PrinterPool#getScanner()
	 * @see #getPrinterPool()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link T6.Printer <em>Printer</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the container reference '{@link T6.Printer#getPool <em>Pool</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the container reference '<em>Pool</em>'.
	 * @see T6.Printer#getPool()
	 * @see #getPrinter()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link T6.Printer#isColor <em>Color</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Color</em>'.
	 * @see T6.Printer#isColor()
	 * @see #getPrinter()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link T6.Scanner <em>Scanner</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the container reference '{@link T6.Scanner#getPool <em>Pool</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the container reference '<em>Pool</em>'.
	 * @see T6.Scanner#getPool()
	 * @see #getScanner()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link T6.Scanner#isColor <em>Color</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Color</em>'.
	 * @see T6.Scanner#isColor()
	 * @see #getScanner()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link T6.impl.PrinterPoolImpl <em>Printer Pool</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see T6.impl.PrinterPoolImpl
		 * @see T6.impl.T6PackageImpl#getPrinterPool()
		...
		/**
		 * The meta object literal for the '{@link T6.impl.PrinterImpl <em>Printer</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see T6.impl.PrinterImpl
		 * @see T6.impl.T6PackageImpl#getPrinter()
		...
		/**
		 * The meta object literal for the '{@link T6.impl.ScannerImpl <em>Scanner</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see T6.impl.ScannerImpl
		 * @see T6.impl.T6PackageImpl#getScanner()
