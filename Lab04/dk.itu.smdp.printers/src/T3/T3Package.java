...
public interface T3Package extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://www.itu.dk/people/wasowski/dk.itu.smdp.T3";
	 ...
	 * @generated
	 */
	T3Package eINSTANCE = T3.impl.T3PackageImpl.init();

	/**
	 * The meta object id for the '{@link T3.impl.PrinterPoolImpl <em>Printer Pool</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see T3.impl.PrinterPoolImpl
	 * @see T3.impl.T3PackageImpl#getPrinterPool()
	 * @generated
	 */
	int PRINTER_POOL = 0;
	...
	/**
	 * Returns the meta object for class '{@link T3.PrinterPool <em>Printer Pool</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link T3.PrinterPool#getMinSpeed <em>Min Speed</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Min Speed</em>'.
	 * @see T3.PrinterPool#getMinSpeed()
	 * @see #getPrinterPool()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link T3.PrinterPool#getSpeed <em>Speed</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Speed</em>'.
	 * @see T3.PrinterPool#getSpeed()
	 * @see #getPrinterPool()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link T3.impl.PrinterPoolImpl <em>Printer Pool</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see T3.impl.PrinterPoolImpl
		 * @see T3.impl.T3PackageImpl#getPrinterPool()
