...
public interface T5Package extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://www.itu.dk/people/wasowski/dk.itu.smdp.printers.T5";
	 ...
	 * @generated
	 */
	T5Package eINSTANCE = T5.impl.T5PackageImpl.init();

	/**
	 * The meta object id for the '{@link T5.impl.PrinterPoolImpl <em>Printer Pool</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see T5.impl.PrinterPoolImpl
	 * @see T5.impl.T5PackageImpl#getPrinterPool()
	 * @generated
	 */
	int PRINTER_POOL = 0;
	...
	/**
	 * The meta object id for the '{@link T5.impl.PrinterImpl <em>Printer</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see T5.impl.PrinterImpl
	 * @see T5.impl.T5PackageImpl#getPrinter()
	 * @generated
	 */
	int PRINTER = 1;
	...
	/**
	 * Returns the meta object for class '{@link T5.PrinterPool <em>Printer Pool</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference list '{@link T5.PrinterPool#getPrinter <em>Printer</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link T5.PrinterPool#isColor <em>Color</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Color</em>'.
	 * @see T5.PrinterPool#isColor()
	 * @see #getPrinterPool()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link T5.Printer <em>Printer</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the container reference '{@link T5.Printer#getPool <em>Pool</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the container reference '<em>Pool</em>'.
	 * @see T5.Printer#getPool()
	 * @see #getPrinter()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link T5.Printer#isColor <em>Color</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Color</em>'.
	 * @see T5.Printer#isColor()
	 * @see #getPrinter()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link T5.impl.PrinterPoolImpl <em>Printer Pool</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see T5.impl.PrinterPoolImpl
		 * @see T5.impl.T5PackageImpl#getPrinterPool()
		...
		/**
		 * The meta object literal for the '{@link T5.impl.PrinterImpl <em>Printer</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see T5.impl.PrinterImpl
		 * @see T5.impl.T5PackageImpl#getPrinter()
