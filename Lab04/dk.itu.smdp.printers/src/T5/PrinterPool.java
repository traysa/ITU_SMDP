 ...
 * <ul>
 *   <li>{@link T5.PrinterPool#getPrinter <em>Printer</em>}</li>
 *   <li>{@link T5.PrinterPool#isColor <em>Color</em>}</li>
 * </ul>
 * </p>
 *
 * @see T5.T5Package#getPrinterPool()
 * @model
 * @generated
 */
public interface PrinterPool extends EObject {
	 ...
	 * The list contents are of type {@link T5.Printer}.
	 * It is bidirectional and its opposite is '{@link T5.Printer#getPool <em>Pool</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see T5.T5Package#getPrinterPool_Printer()
	 ...
	 * @see T5.T5Package#getPrinterPool_Color()
	 * @model required="true"
	 * @generated
	 */
	boolean isColor();
	...
	/**
	 * Sets the value of the '{@link T5.PrinterPool#isColor <em>Color</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
