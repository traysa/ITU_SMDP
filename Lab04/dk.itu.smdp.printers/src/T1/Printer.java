 ...
 * <ul>
 *   <li>{@link T1.Printer#getPool <em>Pool</em>}</li>
 * </ul>
 * </p>
 *
 * @see T1.T1Package#getPrinter()
 * @model
 * @generated
 */
public interface Printer extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link T1.PrinterPool#getPrinter <em>Printer</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see T1.T1Package#getPrinter_Pool()
	...
	/**
	 * Sets the value of the '{@link T1.Printer#getPool <em>Pool</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
