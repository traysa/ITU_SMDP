...
public interface T1Package extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://www.itu.dk/people/wasowski/dk.itu.smdp.printers.T1";
	 ...
	 * @generated
	 */
	T1Package eINSTANCE = T1.impl.T1PackageImpl.init();

	/**
	 * The meta object id for the '{@link T1.impl.PrinterPoolImpl <em>Printer Pool</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see T1.impl.PrinterPoolImpl
	 * @see T1.impl.T1PackageImpl#getPrinterPool()
	 * @generated
	 */
	int PRINTER_POOL = 0;
	...
	/**
	 * The meta object id for the '{@link T1.impl.FaxImpl <em>Fax</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see T1.impl.FaxImpl
	 * @see T1.impl.T1PackageImpl#getFax()
	 * @generated
	 */
	int FAX = 1;
	...
	/**
	 * The meta object id for the '{@link T1.impl.PrinterImpl <em>Printer</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see T1.impl.PrinterImpl
	 * @see T1.impl.T1PackageImpl#getPrinter()
	 * @generated
	 */
	int PRINTER = 2;
	...
	/**
	 * Returns the meta object for class '{@link T1.PrinterPool <em>Printer Pool</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference '{@link T1.PrinterPool#getPrinter <em>Printer</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Printer</em>'.
	 * @see T1.PrinterPool#getPrinter()
	 * @see #getPrinterPool()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the containment reference '{@link T1.PrinterPool#getFax <em>Fax</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link T1.Fax <em>Fax</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the container reference '{@link T1.Fax#getPool <em>Pool</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link T1.Printer <em>Printer</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the container reference '{@link T1.Printer#getPool <em>Pool</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the container reference '<em>Pool</em>'.
	 * @see T1.Printer#getPool()
	 * @see #getPrinter()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link T1.impl.PrinterPoolImpl <em>Printer Pool</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see T1.impl.PrinterPoolImpl
		 * @see T1.impl.T1PackageImpl#getPrinterPool()
		...
		/**
		 * The meta object literal for the '{@link T1.impl.FaxImpl <em>Fax</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see T1.impl.FaxImpl
		 * @see T1.impl.T1PackageImpl#getFax()
		...
		/**
		 * The meta object literal for the '{@link T1.impl.PrinterImpl <em>Printer</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see T1.impl.PrinterImpl
		 * @see T1.impl.T1PackageImpl#getPrinter()
