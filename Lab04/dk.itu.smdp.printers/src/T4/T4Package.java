...
public interface T4Package extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://www.itu.dk/people/wasowski/dk.itu.smdp.printers.T4";
	 ...
	 * @generated
	 */
	T4Package eINSTANCE = T4.impl.T4PackageImpl.init();

	/**
	 * The meta object id for the '{@link T4.impl.PrinterPoolImpl <em>Printer Pool</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see T4.impl.PrinterPoolImpl
	 * @see T4.impl.T4PackageImpl#getPrinterPool()
	 * @generated
	 */
	int PRINTER_POOL = 0;
	...
	/**
	 * The meta object id for the '{@link T4.impl.PrinterImpl <em>Printer</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see T4.impl.PrinterImpl
	 * @see T4.impl.T4PackageImpl#getPrinter()
	 * @generated
	 */
	int PRINTER = 1;
	...
	/**
	 * The meta object id for the '{@link T4.impl.ColorPrinterHeadImpl <em>Color Printer Head</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see T4.impl.ColorPrinterHeadImpl
	 * @see T4.impl.T4PackageImpl#getColorPrinterHead()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link T4.PrinterPool <em>Printer Pool</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference list '{@link T4.PrinterPool#getPrinter <em>Printer</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Printer</em>'.
	 * @see T4.PrinterPool#getPrinter()
	 * @see #getPrinterPool()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link T4.Printer <em>Printer</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the container reference '{@link T4.Printer#getPool <em>Pool</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference '{@link T4.Printer#getHead <em>Head</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Head</em>'.
	 * @see T4.Printer#getHead()
	 * @see #getPrinter()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link T4.Printer#isColor <em>Color</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Color</em>'.
	 * @see T4.Printer#isColor()
	 * @see #getPrinter()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link T4.ColorPrinterHead <em>Color Printer Head</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Color Printer Head</em>'.
	 * @see T4.ColorPrinterHead
	 * @generated
	 */
	EClass getColorPrinterHead();

	/**
	 * Returns the meta object for the container reference '{@link T4.ColorPrinterHead#getPrinter <em>Printer</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the container reference '<em>Printer</em>'.
	 * @see T4.ColorPrinterHead#getPrinter()
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link T4.impl.PrinterPoolImpl <em>Printer Pool</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see T4.impl.PrinterPoolImpl
		 * @see T4.impl.T4PackageImpl#getPrinterPool()
		...
		/**
		 * The meta object literal for the '{@link T4.impl.PrinterImpl <em>Printer</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see T4.impl.PrinterImpl
		 * @see T4.impl.T4PackageImpl#getPrinter()
		...
		/**
		 * The meta object literal for the '{@link T4.impl.ColorPrinterHeadImpl <em>Color Printer Head</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see T4.impl.ColorPrinterHeadImpl
		 * @see T4.impl.T4PackageImpl#getColorPrinterHead()
