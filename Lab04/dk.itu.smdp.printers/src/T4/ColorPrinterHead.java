 ...
 * <ul>
 *   <li>{@link T4.ColorPrinterHead#getPrinter <em>Printer</em>}</li>
 * </ul>
 * </p>
 *
 * @see T4.T4Package#getColorPrinterHead()
 * @model
 * @generated
 */
public interface ColorPrinterHead extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link T4.Printer#getHead <em>Head</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see T4.T4Package#getColorPrinterHead_Printer()
	...
	/**
	 * Sets the value of the '{@link T4.ColorPrinterHead#getPrinter <em>Printer</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
