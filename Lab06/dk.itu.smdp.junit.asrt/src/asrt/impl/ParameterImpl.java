 ...
 * <ul>
 *   <li>{@link asrt.impl.ParameterImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParameterImpl extends NamedElementImpl implements Parameter {
	...
	protected EClass eStaticClass() {
		return AsrtPackage.Literals.PARAMETER;
	}
	...
	public void setType(SimpleTypeEnum newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AsrtPackage.PARAMETER__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AsrtPackage.PARAMETER__TYPE:
				return getType();
		}
