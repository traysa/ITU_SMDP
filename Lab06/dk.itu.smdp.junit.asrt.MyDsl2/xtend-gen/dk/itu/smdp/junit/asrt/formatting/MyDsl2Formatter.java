 ...
 * generated by Xtext
 */
package dk.itu.smdp.junit.asrt.formatting;
...
public class MyDsl2Formatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private MyDsl2GrammarAccess _myDsl2GrammarAccess;
  
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword,Keyword>> _findKeywordPairs = this._myDsl2GrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._myDsl2GrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._myDsl2GrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._myDsl2GrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._myDsl2GrammarAccess.getML_COMMENTRule();
